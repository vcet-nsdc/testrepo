...
import { EventCard, type PastEvent } from "./EventCard";
...
export function PastEventsSection({ events = [] }: PastEventsSectionProps) {
  ...
  const sampleEvents: PastEvent[] = [
    ...
    },
    {
      ...
      venue: "VCET, Vasai",
      description:
        "A coding competition where participants build real-world software solutions and present them to judges.",
      about:
        "Code-o-Fiesta is a dynamic coding event designed to challenge and enhance participants' problem-solving abilities while applying their skills to real-life scenarios. Prior to the event, teams receive problem statements focused on developing innovative software or product solutions with practical applications. On the event day, participants showcase their completed projects to a panel of judges, making this competition both a test of technical expertise and a platform for meaningful innovation.",
      highlights: [
    ...
    },
    {
      ...
      description:
        "TechX – Technical Showcase. Participate and present your innovative technical projects.",
      about:
    ...
    },
    {
      ...
      venue: "VCET, Vasai",
      description:
        "Design unique logos showcasing creativity and innovation.",
      about:
        "On September 3rd, 2024, a creative and engaging Logo Making Competition was organized as part of the ICE3T event. The competition centered around the College Paper Publication theme, with participants tasked to design logos that represented the diverse domains outlined on the ICE3T website. These domains ranged from cutting-edge technologies like Data Science, Cloud Computing, and IoT to traditional fields such as Civil Engineering and Indigenous Knowledge Systems, reflecting the broad spectrum of research areas.",
      highlights: [
    ...
    },
    {
      ...
      venue: "VCET, Vasai",
      description:
        "The seminar on NVIDIA Jetson AI Edge Device organized by our college is held on 30th August 2024 in association with IETE. Mr. Anil Sarode explained the working and functioning of NVIDIA jetson devices.",
      about:
        "The seminar on NVIDIA Jetson AI Edge Device is designed to introduce participants to the NVIDIA Jetson AI Edge Devices and Software Stacks Overview. The seminar begins with an overview of the NVIDIA Jetson AI Edge device introduction, covering its architecture, key features, and various applications. Participants are then guided through live Jetson demo with Deepstream & Generative AI. The seminar includes hands-on sessions where attendees learn to use Deepstream & Generative AI efficiently with the NVIDIA Jetson device and Software Stacks.",
      highlights: [
    ...
    },
    {
      ...
      venue: "VCET, Vasai",
      description:
        "Techblitz redefines coding competitions by embracing AI tools, breaking away from traditional restrictions.",
      about:
        "The TechBlitz challenge event organized by the National Students Data Corps (NSDC) at Vidyavardhini's College of Engineering and Technology (VCET) on March 15th, 2024, marked a significant milestone in the intersection of technology and education. Under the auspices of the Department of Artificial Intelligence and Data Science, the event showcased the prowess of budding technologists across three pivotal domains: web development using AI, UI/UX design, and data science using AI.",
      highlights: [
    ...
    },
    {
      ...
      venue: "VCET, Vasai",
      description:
        "Students gained hands-on insights into the world of business intelligence, data visualization, and analytics.",
      about:
        "The lecture focused on introducing students to Microsoft Power BI, a powerful tool for data analysis and interactive reporting. The resource person guided participants through real-world applications, dashboards, and visualization techniques, enabling them to understand how data-driven decision-making is transforming industries. The session also emphasized career opportunities in the field of business intelligence and analytics.",
      highlights: [
    ...
    },
    {
      ...
      venue: "VCET, Vasai",
      description:
        "The VCET TechZette – विसीईटी ज्ञानपत्र (www.techz.vcet.edu.in), a dynamic technical blog, serves as a digital hub for insightful discourse, featuring a plethora of technical articles",
      about:
    ...
    },
    {
      ...
      venue: "VCET, Vasai",
      description:
        "The National Student Data Corps (NSDC) stands as a beacon of opportunity, ushering students into the vibrant world of data science within a nurturing community.",
      about:
        "The Inauguration of the National Students Data Corps (NSDC) student chapter under the Department of Artificial Intelligence and Data Science at Vidyavardhini's College of Engineering and Technology was a momentous occasion marked by excitement and promise. Chief Guest Mr. Rahul Mhatre along with faculty members, guests, as well as Students gathered to witness the unveiling of this pioneering initiative aimed at harnessing the power of data for transformative change.",
      highlights: [
  ...
  // Group events by year (newest first: 2026 down to 2023)
  const groupedEventsByYear: Record<string, PastEvent[]> = {
    "2026": allEvents.filter(
      (e) => e.date.startsWith("2026") || e.id === "event_techblitz_2026"
    ),
    "2025": allEvents.filter(
      (e) =>
        e.id === "event_000" ||
        e.id === "event_001" ||
        e.id === "event_002"
    ),
    "2024": allEvents.filter(
      (e) =>
        e.id === "event_003" ||
        e.id === "event_004" ||
        e.id === "event_005" ||
  ...
  const getYearMeta = (year: string) => {
    switch (year) {
      ...
      case "2023":
        return {
          academicYear: "Academic Year 2022–23",
  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[350px] bg-purple-900/15 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-purple-900/40 border border-purple-500/30 rounded-full px-4 py-1.5 mb-4 backdrop-blur-md">
            <Sparkles className="w-3.5 h-3.5 text-pink-400" />
            <span className="text-xs font-heading uppercase tracking-wider text-purple-200">
          ...
          <p className="text-lg text-purple-200/80 max-w-2xl mx-auto text-pretty">
            Explore our previous hackathons, tech exhibitions, hands-on workshops, and milestones
          </p>
        </motion.div>

        {/* Year-by-Year Sections: 2026 down to 2023 */}
        <div className="space-y-20">
          {years.map((year) => {
            const yearEvents = groupedEventsByYear[year] || [];
            if (yearEvents.length === 0) return null;
            const meta = getYearMeta(year);

            return (
              <div key={year} className="relative">
                {/* Labeled Year Section Header */}
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-8 pb-4 border-b border-purple-500/20">
                  <div className="flex items-center gap-4">
                    <div
                      className={`h-10 px-4 rounded-xl bg-gradient-to-r ${meta.badgeColor} flex items-center justify-center font-heading font-bold text-white text-lg shadow-lg shadow-purple-950/50`}
                    >
                      {year}
                    </div>
                    <div>
                      <h3 className="text-xl sm:text-2xl font-heading font-bold text-white tracking-tight flex items-center gap-2">
                        {year} Events
                      </h3>
                      <p className="text-xs text-purple-300/70 font-body">
                        {meta.academicYear}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2 self-start sm:self-auto">
                    <span className="inline-flex items-center gap-1.5 text-xs font-body text-purple-200/80 bg-white/5 border border-white/10 px-3 py-1 rounded-full">
                ...
                {/* Varied & Balanced Grid Layout */}
                {year === "2026" ? (
                  /* 2026 (Single event): Featured balanced layout */
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="hidden md:flex flex-col justify-center p-8 rounded-3xl border border-dashed border-purple-500/25 bg-purple-950/20 text-center">
                      <Sparkles className="w-8 h-8 text-pink-400 mx-auto mb-3 opacity-80" />
                      <h4 className="text-base font-heading font-semibold text-white mb-2">
                        2026 Season
                      </h4>
                      <p className="text-xs text-purple-300/70 font-body leading-relaxed">
                        Stay tuned for additional competitions, symposiums, and tech showcases coming throughout 2026.
                      </p>
                    </div>
                  </div>
                ) : year === "2025" ? (
                  /* 2025 (3 events): 3-column clean grid */
                  ...
                  /* 2024 (6 events): Visually varied 3-column grid */
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {yearEvents.map((event, idx) => (
                      <EventCard
                        ...
                        event={event}
                        onClick={setSelectedEvent}
                        isFeatured={idx === 0 || idx === 3}
                      />
                    ))}
                  </div>
                ) : (
                  /* 2023 (4 events): Balanced 4-column responsive grid */
